...
function Sidebar() {
  ...
  const menuItems = [
    ...
    { id: "gauge", icon: <FaTachometerAlt size={20} />, label: "Gauge" },
  ...
  return (
    <div className="flex flex-col items-center bg-gray-900 text-white h-screen w-16 py-4 justify-between">
      {/* Top logo */}
      <div className="bg-gray-700 rounded-md px-2 py-1 font-bold">B</div>
